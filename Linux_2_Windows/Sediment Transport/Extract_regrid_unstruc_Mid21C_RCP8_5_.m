...
%%
aaa= nan(size(HADGEM2_ES_dm0p5_2026_2045,1), 1, 240);
aaa(:,:,1:size(HADGEM2_ES_dm0p5_2026_2045,3))=HADGEM2_ES_dm0p5_2026_2045;
HADGEM2_ES_dm0p5_2026_2045=aaa;

aaa= nan(size(HADGEM2_ES_hs0p5_2026_2045,1), 1, 240);
aaa(:,:,1:size(HADGEM2_ES_hs0p5_2026_2045,3))=HADGEM2_ES_hs0p5_2026_2045;
HADGEM2_ES_hs0p5_2026_2045=aaa;

aaa= nan(size(HADGEM2_ES_tm0p5_2026_2045,1), 1, 240);
aaa(:,:,1:size(HADGEM2_ES_tm0p5_2026_2045,3))=HADGEM2_ES_tm0p5_2026_2045;
...
ENSEMBLE_hs_Mid_8p5 =permute(ENSEMBLE_hs_Mid_8p5 , [1 3 2]);
ENSEMBLE_tm_Mid_8p5 =permute(ENSEMBLE_tm_Mid_8p5 , [1 3 2]);
ENSEMBLE_dm_Mid_8p5 =permute(ENSEMBLE_dm_Mid_8p5 , [1 3 2]);
