...
%% Change time to the last dimension (lon lat time)dm_ac=permute(dm_ac,[3 2 1]);
...
% [QLON, QLAT] = ndgrid(QLON, QLAT,'nearest');
...
%%
ACCESS1_0_hs0p5_1979_2005= [];
ACCESS1_0_tm0p5_1979_2005= [];
ACCESS1_0_dm0p5_1979_2005= [];

BCC_CSM1_1_hs0p5_1979_2005= [];
BCC_CSM1_1_tm0p5_1979_2005= [];
BCC_CSM1_1_dm0p5_1979_2005= [];

CNRM_CM5_hs0p5_1979_2005= [];
CNRM_CM5_tm0p5_1979_2005= [];
CNRM_CM5_dm0p5_1979_2005= [];

GFDL_CM3_hs0p5_1979_2005= [];
GFDL_CM3_tm0p5_1979_2005= [];
GFDL_CM3_dm0p5_1979_2005= [];

HADGEM2_ES_hs0p5_1979_2005= [];
HADGEM2_ES_tm0p5_1979_2005= [];
HADGEM2_ES_dm0p5_1979_2005= [];

INM_CM4_hs0p5_1979_2005= [];
INM_CM4_tm0p5_1979_2005= [];
INM_CM4_dm0p5_1979_2005= [];

MIROC5_hs0p5_1979_2005= [];
MIROC5_tm0p5_1979_2005= [];
MIROC5_dm0p5_1979_2005= [];

MRI_CGCM3_hs0p5_1979_2005= [];
MRI_CGCM3_tm0p5_1979_2005= [];
MRI_CGCM3_dm0p5_1979_2005= [];

%%

for time = 1 : nhs
ACCESS1_0_hs0p5_1979_2005(:,:,time) = interp2(Xlong, Ylat, hs_ac(:,:,time)', QLON, QLAT,'nearest');
ACCESS1_0_tm0p5_1979_2005(:,:,time) = interp2(Xlong, Ylat, tm_ac(:,:,time)', QLON, QLAT,'nearest');
ACCESS1_0_dm0p5_1979_2005(:,:,time) = interp2(Xlong, Ylat, dm_ac(:,:,time)', QLON, QLAT,'nearest');
    
BCC_CSM1_1_hs0p5_1979_2005(:,:,time) = interp2(Xlong, Ylat, hs_bc(:,:,time)', QLON, QLAT,'nearest');
BCC_CSM1_1_tm0p5_1979_2005(:,:,time) = interp2(Xlong, Ylat, tm_bc(:,:,time)', QLON, QLAT,'nearest');
BCC_CSM1_1_dm0p5_1979_2005(:,:,time) = interp2(Xlong, Ylat, dm_bc(:,:,time)', QLON, QLAT,'nearest');
    
CNRM_CM5_hs0p5_1979_2005(:,:,time) = interp2(Xlong, Ylat, hs_cn(:,:,time)', QLON, QLAT,'nearest');
CNRM_CM5_tm0p5_1979_2005(:,:,time) = interp2(Xlong, Ylat, tm_cn(:,:,time)', QLON, QLAT,'nearest');
CNRM_CM5_dm0p5_1979_2005(:,:,time) = interp2(Xlong, Ylat, dm_cn(:,:,time)', QLON, QLAT,'nearest');

GFDL_CM3_hs0p5_1979_2005(:,:,time) = interp2(Xlong, Ylat, hs_gf(:,:,time)', QLON, QLAT,'nearest');
GFDL_CM3_tm0p5_1979_2005(:,:,time) = interp2(Xlong, Ylat, tm_gf(:,:,time)', QLON, QLAT,'nearest');
GFDL_CM3_dm0p5_1979_2005(:,:,time) = interp2(Xlong, Ylat, dm_gf(:,:,time)', QLON, QLAT,'nearest');
    
HADGEM2_ES_hs0p5_1979_2005(:,:,time) = interp2(Xlong, Ylat, hs_ha(:,:,time)', QLON, QLAT,'nearest');
HADGEM2_ES_tm0p5_1979_2005(:,:,time) = interp2(Xlong, Ylat, tm_ha(:,:,time)', QLON, QLAT,'nearest');
HADGEM2_ES_dm0p5_1979_2005(:,:,time) = interp2(Xlong, Ylat, dm_ha(:,:,time)', QLON, QLAT,'nearest');

INM_CM4_hs0p5_1979_2005(:,:,time) = interp2(Xlong, Ylat, hs_in(:,:,time)', QLON, QLAT,'nearest');
INM_CM4_tm0p5_1979_2005(:,:,time) = interp2(Xlong, Ylat, tm_in(:,:,time)', QLON, QLAT,'nearest');
INM_CM4_dm0p5_1979_2005(:,:,time) = interp2(Xlong, Ylat, dm_in(:,:,time)', QLON, QLAT,'nearest');

MIROC5_hs0p5_1979_2005(:,:,time) = interp2(Xlong, Ylat, hs_mi(:,:,time)', QLON, QLAT,'nearest');
MIROC5_tm0p5_1979_2005(:,:,time) = interp2(Xlong, Ylat, tm_mi(:,:,time)', QLON, QLAT,'nearest');
MIROC5_dm0p5_1979_2005(:,:,time) = interp2(Xlong, Ylat, dm_mi(:,:,time)', QLON, QLAT,'nearest');

MRI_CGCM3_hs0p5_1979_2005(:,:,time) = interp2(Xlong, Ylat, hs_mr(:,:,time)', QLON, QLAT,'nearest');
MRI_CGCM3_tm0p5_1979_2005(:,:,time) = interp2(Xlong, Ylat, tm_mr(:,:,time)', QLON, QLAT,'nearest');
MRI_CGCM3_dm0p5_1979_2005(:,:,time) = interp2(Xlong, Ylat, dm_mr(:,:,time)', QLON, QLAT,'nearest');
end
Xlong=lon(:,1); Xlong=Xlong'; Ylat=lat(:,1);

clearvars -EXCEPT ACCESS1_0_dm0p5_1979_2005 ACCESS1_0_hs0p5_1979_2005 ACCESS1_0_tm0p5_1979_2005...
...
ENSEMBLE_hs_hist=permute(ENSEMBLE_hs_hist, [1 3 2]);
ENSEMBLE_tm_hist=permute(ENSEMBLE_tm_hist, [1 3 2]);
ENSEMBLE_dm_hist=permute(ENSEMBLE_dm_hist, [1 3 2]);
