%Load data
clc; clear;
load('D:\Review Papers\Sediment Transport\Hs_Dm_Tm_Extracted/All_models_End21C_RCP8_5.mat');
...
%%
ACCESS1_0_hs0p5_2081_2100= [];;
ACCESS1_0_tm0p5_2081_2100= [];;
ACCESS1_0_dm0p5_2081_2100= [];;

BCC_CSM1_1_hs0p5_2081_2100= [];;
BCC_CSM1_1_tm0p5_2081_2100= [];;
BCC_CSM1_1_dm0p5_2081_2100= [];;

CNRM_CM5_hs0p5_2081_2100= [];;
CNRM_CM5_tm0p5_2081_2100= [];;
CNRM_CM5_dm0p5_2081_2100= [];;

GFDL_CM3_hs0p5_2081_2100= [];;
GFDL_CM3_tm0p5_2081_2100= [];;
GFDL_CM3_dm0p5_2081_2100= [];;

HADGEM2_ES_hs0p5_2081_2100= [];;
HADGEM2_ES_tm0p5_2081_2100= [];;
HADGEM2_ES_dm0p5_2081_2100= [];;

INM_CM4_hs0p5_2081_2100= [];;
INM_CM4_tm0p5_2081_2100= [];;
INM_CM4_dm0p5_2081_2100= [];;

MIROC5_hs0p5_2081_2100= [];;
MIROC5_tm0p5_2081_2100= [];;
MIROC5_dm0p5_2081_2100= [];;

MRI_CGCM3_hs0p5_2081_2100= [];;
MRI_CGCM3_tm0p5_2081_2100= [];;
MRI_CGCM3_dm0p5_2081_2100= [];;
...
aaa= nan(size(BCC_CSM1_1_dm0p5_2081_2100,1), 1, 240);
aaa(:,:,1:size(BCC_CSM1_1_dm0p5_2081_2100,3))=BCC_CSM1_1_dm0p5_2081_2100;
BCC_CSM1_1_dm0p5_2081_2100=aaa;

aaa= nan(size(BCC_CSM1_1_tm0p5_2081_2100,1), 1, 240);
aaa(:,:,1:size(BCC_CSM1_1_tm0p5_2081_2100,3))=BCC_CSM1_1_tm0p5_2081_2100;
BCC_CSM1_1_tm0p5_2081_2100=aaa;

aaa= nan(size(BCC_CSM1_1_hs0p5_2081_2100,1), 1, 240);
aaa(:,:,1:size(BCC_CSM1_1_hs0p5_2081_2100,3))=BCC_CSM1_1_hs0p5_2081_2100;
BCC_CSM1_1_hs0p5_2081_2100=aaa;

aaa= nan(size(HADGEM2_ES_dm0p5_2081_2100,1), 1, 240);
aaa(:,:,1:size(HADGEM2_ES_dm0p5_2081_2100,3))=HADGEM2_ES_dm0p5_2081_2100;
HADGEM2_ES_dm0p5_2081_2100=aaa;

aaa= nan(size(HADGEM2_ES_hs0p5_2081_2100,1), 1, 240);
aaa(:,:,1:size(HADGEM2_ES_hs0p5_2081_2100,3))=HADGEM2_ES_hs0p5_2081_2100;
HADGEM2_ES_hs0p5_2081_2100=aaa;

aaa= nan(size(HADGEM2_ES_tm0p5_2081_2100,1), 1, 240);
aaa(:,:,1:size(HADGEM2_ES_tm0p5_2081_2100,3))=HADGEM2_ES_tm0p5_2081_2100;
...
ENSEMBLE_hs_End_8p5 =permute(ENSEMBLE_hs_End_8p5 , [1 3 2]);
ENSEMBLE_tm_End_8p5 =permute(ENSEMBLE_tm_End_8p5 , [1 3 2]);
ENSEMBLE_dm_End_8p5 =permute(ENSEMBLE_dm_End_8p5 , [1 3 2]);
...
hs_unstruct=ENSEMBLE_hs_End_8p5;
tm_unstruct=ENSEMBLE_tm_End_8p5;
dm_unstruct=ENSEMBLE_dm_End_8p5;

nhs = size(ENSEMBLE_hs_End_8p5,2);
