%Load data
clc; clear;
load('D:\Review Papers\Sediment Transport\Hs_Dm_Tm_Extracted/All_models_End21C_RCP4_5.mat');
...
ENSEMBLE_hs_End_4p5 =permute(ENSEMBLE_hs_End_4p5 , [1 3 2]);
ENSEMBLE_tm_End_4p5 =permute(ENSEMBLE_tm_End_4p5 , [1 3 2]);
ENSEMBLE_dm_End_4p5 =permute(ENSEMBLE_dm_End_4p5 , [1 3 2]);
...
hs_unstruct=ENSEMBLE_hs_End_4p5;
tm_unstruct=ENSEMBLE_tm_End_4p5;
dm_unstruct=ENSEMBLE_dm_End_4p5;

nhs = size(ENSEMBLE_hs_End_4p5,2);
