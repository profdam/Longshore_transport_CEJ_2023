%Load data
clc; clear;
load('/home/profdam/Downloads/INPUT_DATA/CSIRO/Hs_Dm_Tm_Extracted/All_models_Mid21C_RCP4_5.mat');
...
HADGEM2_ES_hs0p5_2026_2045= zeros(size(QLON,1), size(QLON,2), nhs);
HADGEM2_ES_tm0p5_2026_2045= zeros(size(QLON,1), size(QLON,2), nhs);
HADGEM2_ES_dm0p5_2026_2045= zeros(size(QLON,1), size(QLON,2), nhs);
