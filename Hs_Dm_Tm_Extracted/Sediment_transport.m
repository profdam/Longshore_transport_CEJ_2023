...
clc;clear;
%load('/home/profdam/Downloads/INPUT_DATA/CSIRO/Hs_Dm_Tm_Extracted/Selected_HS_TM_DM_ENSEMBLE_yearly.mat', 'DM_hist_', 'HS_hist_', 'TM_hist_', 'lat_f', 'lon_f')
load('D:\Review Papers\Sediment Transport\Hs_Dm_Tm_Extracted/Selected_HS_TM_DM_ENSEMBLE_yearly.mat', 'DM_hist_', 'HS_hist_', 'TM_hist_', 'lat_f', 'lon_f')
...
%ANGLE=ANGLE';
hs_a_f=HS_hist_; tm_a_f=TM_hist_; dm_a_f=DM_hist_;
abcc=[];
for i=1:27
...
load('/home/profdam/Downloads/INPUT_DATA/CSIRO/Hs_Dm_Tm_Extracted/Selected_HS_TM_DM_ENSEMBLE_yearly.mat', 'DM_Mid_4p5_', 'HS_Mid_4p5_', 'TM_Mid_4p5_', 'lat_f', 'lon_f')
...
%ANGLE=ANGLE';
hs_a_f=HS_Mid_4p5_; tm_a_f=TM_Mid_4p5_; dm_a_f=DM_Mid_4p5_;
abcc=[];
for i=1:20
if dm_a_f(:,i)<180 & dm_a_f(:,i)>90
    abb=dm_a_f(:,i)+180;
...
clearvars -EXCEPT Q_hist Q_Mid_4p5
