%Load data
clc; clear;
load('/home/profdam/Downloads/INPUT_DATA/CSIRO/Hs_Dm_Tm_Extracted/All_models_Mid21C_RCP8_5.mat');
...
%%
ACCESS1_0_hs0p5_2026_2045= zeros(size(QLON,1), size(QLON,2), nhs);
ACCESS1_0_tm0p5_2026_2045= zeros(size(QLON,1), size(QLON,2), nhs);
ACCESS1_0_dm0p5_2026_2045= zeros(size(QLON,1), size(QLON,2), nhs);

BCC_CSM1_1_hs0p5_2026_2045= zeros(size(QLON,1), size(QLON,2), nhs);
BCC_CSM1_1_tm0p5_2026_2045= zeros(size(QLON,1), size(QLON,2), nhs);
BCC_CSM1_1_dm0p5_2026_2045= zeros(size(QLON,1), size(QLON,2), nhs);

CNRM_CM5_hs0p5_2026_2045= zeros(size(QLON,1), size(QLON,2), nhs);
CNRM_CM5_tm0p5_2026_2045= zeros(size(QLON,1), size(QLON,2), nhs);
CNRM_CM5_dm0p5_2026_2045= zeros(size(QLON,1), size(QLON,2), nhs);

GFDL_CM3_hs0p5_2026_2045= zeros(size(QLON,1), size(QLON,2), nhs);
GFDL_CM3_tm0p5_2026_2045= zeros(size(QLON,1), size(QLON,2), nhs);
GFDL_CM3_dm0p5_2026_2045= zeros(size(QLON,1), size(QLON,2), nhs);

HADGEM2_ES_hs0p5_2026_2045= zeros(size(QLON,1), size(QLON,2), 239);
HADGEM2_ES_tm0p5_2026_2045= zeros(size(QLON,1), size(QLON,2), 239);
HADGEM2_ES_dm0p5_2026_2045= zeros(size(QLON,1), size(QLON,2), 239);

INM_CM4_hs0p5_2026_2045= zeros(size(QLON,1), size(QLON,2), nhs);
INM_CM4_tm0p5_2026_2045= zeros(size(QLON,1), size(QLON,2), nhs);
INM_CM4_dm0p5_2026_2045= zeros(size(QLON,1), size(QLON,2), nhs);

MIROC5_hs0p5_2026_2045= zeros(size(QLON,1), size(QLON,2), nhs);
MIROC5_tm0p5_2026_2045= zeros(size(QLON,1), size(QLON,2), nhs);
MIROC5_dm0p5_2026_2045= zeros(size(QLON,1), size(QLON,2), nhs);

MRI_CGCM3_hs0p5_2026_2045= zeros(size(QLON,1), size(QLON,2), nhs);
MRI_CGCM3_tm0p5_2026_2045= zeros(size(QLON,1), size(QLON,2), nhs);
MRI_CGCM3_dm0p5_2026_2045= zeros(size(QLON,1), size(QLON,2), nhs);
